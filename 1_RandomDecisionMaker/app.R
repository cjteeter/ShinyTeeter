##### Shiny App for Selecting an Option at Random #####
...
ui <- fluidPage(theme = shinytheme('spacelab'),
        ...
        p(tags$em('Note'), ": the", tags$em('Reset'), "button will reload the page if you want to start over and/or have it make another decision for you."),
        hr(),
                ...
                sidebarPanel(
                        ...
                        conditionalPanel(condition = "input.smp_adv == '1'",
                                         sliderInput(inputId = 'num_options',
                                                     ...
                                                     step = 1),
                                         hr(),
                                         actionButton(inputId = 's_generate', label = 'Make Decision'),
                                         actionButton(inputId = 's_reset', label = 'Reset')),
                        conditionalPanel(condition = "input.smp_adv == '2'",
                                         ...
                                         hr(),
                                         actionButton(inputId = 'a_generate', label = 'Make Decision'),
                                         actionButton(inputId = 'a_reset', label = 'Reset')),
                        hr()),
